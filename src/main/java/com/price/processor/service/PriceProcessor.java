 ...
 * are very slow (onPrice() might take 30 minutes). Imagine that some subscribers might be showing a price on a
 * screen and some might be printing them on a paper
 ...
 * more frequent at different time of a day
